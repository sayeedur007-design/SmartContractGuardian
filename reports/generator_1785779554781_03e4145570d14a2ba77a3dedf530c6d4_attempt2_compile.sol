...
contract TestOwnershipBug is BaseTestWithBalanceLog {
    ...
    function setUp() public {
        super.setUp();
        owner = address(0x123); // Set the owner address, assuming it's not directly accessible
        attacker = address(0x456); // Set the attacker address, assuming it's not directly accessible
