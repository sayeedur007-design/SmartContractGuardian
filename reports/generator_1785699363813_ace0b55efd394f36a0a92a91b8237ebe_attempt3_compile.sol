...
contract ExploitTest is BaseTestWithBalanceLog {
    ...
    function testExploit() public {
        ...
        // Check that the recipient did not receive any Ether
        assertEq(target.balances(address(recipient)), 0);
        assertEq(target.balances(address(sender)), 2 ether);
        ...
        balanceLog.requireNoBalanceChange(address(recipient), "Recipient should not have received any Ether");
    }
}